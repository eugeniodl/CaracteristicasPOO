public class CuentaPremium : CuentaBancariaBase
{
    ...
    {
        Console.WriteLine("Aplicando beneficio cuenta Premium...");
    ...
    protected override void AcreditarInterno(decimal monto, 
        string concepto)
    {
        Console.WriteLine("[Override Premium] Aplicando multiplicador " +
            "1.1x por fidelidad");
        base.AcreditarInterno(monto * 1.1m, concepto 
            + " (Multiplicando)");
    }
