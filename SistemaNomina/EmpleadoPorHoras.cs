public class EmpleadoPorHoras : Empleado
{
    ...
    public decimal SueldoPorHora
    {
        ...
        {
            if (value <= 0)
                throw new ArgumentException("El sueldo por hora debe ser mayor a 0");
    ...
    public int HorasTrabajadas
    {
        ...
        private set
        {
            ...
            if (value > 720) // Máximo horas en un mes
                throw new ArgumentException("Horas exceden el límite mensual");
    ...
    {
        return $"Empleado por Horas: {NombreCompleto} | ${SueldoPorHora}/hora | " +
